...
export const STRINGS = {
  lv: {
    ...
    infoBondsBody: 'Obligācija ir aizdevums valstij vai uzņēmumam. Pretī Tu regulāri saņem procentus (kuponu), kas var būt fiksēti vai mainīgi, piemēram, piesaistīti EURIBOR likmei, un termiņa beigās atgūsti ieguldīto summu. Jo augstāks kupons, jo lielāku risku tirgus saskata aizņēmējā: valsts maksā mazāk, uzņēmumi vairāk.',
    ...
    gateKicker: 'Vēl tikai viens solis',
    gateTitle: 'Tavs rezultāts ir gatavs',
    gateSub: 'Ievadi savu e-pastu, un mēs parādīsim, kas pēdējos 12 mēnešos notika ar Taviem 10 000 €.',
    gateLabel: 'Tavs e-pasts',
    gatePlaceholder: 'vards@epasts.lv',
    gateConsent: 'Piekrītu, ka Signet Bank var sazināties ar mani par ieguldījumu iespējām.',
    gateInvalid: 'Lūdzu, ievadi derīgu e-pasta adresi.',
    gateSkip: 'Turpināt bez e-pasta',

    leadsTitle: 'Savāktie e-pasti',
    leadsCount: 'Ieraksti: {n}',
    leadsPending: 'vēl nav nosūtīti uz serveri: {n}',
    leadsEmpty: 'Vēl nav neviena e-pasta.',
    leadsCopy: 'Kopēt CSV',
    leadsCopied: 'Nokopēts',
    leadsDownload: 'Lejupielādēt CSV',
    leadsClear: 'Dzēst visus',
    leadsClearConfirm: 'Dzēst visus šajā ierīcē savāktos e-pastus?',
    close: 'Aizvērt',
  ...
  en: {
    ...
    infoBondsBody: 'A bond is a loan to a government or a company. In return you receive regular interest (the coupon), which can be fixed or floating, for example tied to the EURIBOR rate, and at maturity you get your money back. The higher the coupon, the more risk the market sees in the borrower: governments pay less, companies pay more.',
    ...
    gateKicker: 'One last step',
    gateTitle: 'Your result is ready',
    gateSub: 'Enter your e-mail and we will show you what happened to your €10,000 over the past 12 months.',
    gateLabel: 'Your e-mail',
    gatePlaceholder: 'name@email.com',
    gateConsent: 'I agree that Signet Bank may contact me about investment opportunities.',
    gateInvalid: 'Please enter a valid e-mail address.',
    gateSkip: 'Continue without e-mail',

    leadsTitle: 'Collected e-mails',
    leadsCount: 'Entries: {n}',
    leadsPending: 'not yet sent to the server: {n}',
    leadsEmpty: 'No e-mails yet.',
    leadsCopy: 'Copy CSV',
    leadsCopied: 'Copied',
    leadsDownload: 'Download CSV',
    leadsClear: 'Delete all',
    leadsClearConfirm: 'Delete all e-mails collected on this device?',
    close: 'Close',
...
export const QUIZ = {
  lv: [
    ...
    },
    {
      ...
      options: ['Procenti, ko aizņēmējs regulāri maksā ieguldītājam', 'Atlaižu kods akciju pirkšanai', 'Biržas komisijas maksa'],
      correct: 0,
      fact: 'Kupons ir obligācijas procentu maksājums. Tas var būt fiksēts vai mainīgs, piemēram, piesaistīts EURIBOR likmei. Baltijas uzņēmumu obligācijās kupons šobrīd parasti ir 8 līdz 11 % gadā.',
    },
    {
  ...
  en: [
    ...
    },
    {
      ...
      options: ['The interest the borrower pays the investor at regular intervals', 'A discount code for buying stocks', 'The stock exchange fee'],
      correct: 0,
      fact: 'The coupon is the bond’s interest payment. It can be fixed or floating, for example tied to the EURIBOR rate. Baltic corporate bonds currently pay around 8 to 11% a year.',
    },
    {
